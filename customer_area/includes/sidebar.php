...
<div class="card">
	<div class="card-header p-0">
		<img src="customer_img/1.jpg" class="img-fluid">
		
	</div>
	<div class="card-body px-2">
		<h5 class="text-center card-title mt-2">User Name</h5>	
 ...
 -->
			...
			<li class="nav-item <?php if (isset($_REQUEST['logout'])){echo "active";} ?>">
				<a href="my_account.php?logout" class="nav-link <?php if (isset($_REQUEST['logout'])){echo "active";} ?>"><i class="fa fa-sign-out mr-2" ></i>Logout</a>
			</li>
		</ul>
	</div>
</div>